from next_scraper.utils.logging import get_logger
...
class TestGetLogger:
    ...
    def test_class(self):
        ...
        assert logger.name == "next_scraper.tests.utils.test_logging.TestClass"

    def test_method(self):
        logger = get_logger(TestClass.test)
        assert logger.name == "next_scraper.tests.utils.test_logging.TestClass.test"
